...
// TODO Many of these might need to be done in the VAB...

// Establish global variables
local terminal_velocity is ship:TERMVELOCITY.
// FUTURE Check to see how terminal_velocity compares to individual boosters vs. the fully fueled vessel.
// FUTURE Dynamically generate this value.
set required_landing_dv to 1.5 * terminal_velocity.

local total_upper_dv is 1000.  // FUTURE Determine this dynamically.
...
local u is constant:G * Kerbin:Mass.  // May need to update for kOS 1.0+
...
// FUTURE - Warn if margins are exceeded
